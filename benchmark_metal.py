...
def check_array_type(arr, name):
    """Helper function to identify array type and location."""
...
if __name__ == '__main__':
    # CRITICAL for macOS/Windows: This guard is required for multiprocessing
    # The parallel LHC optimizer uses multiprocessing.Pool, which needs this
    # protection on platforms that use 'spawn' instead of 'fork'
    main()
